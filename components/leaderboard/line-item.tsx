...
export default function LineItem({
  ...
  return (
    <div className="mx-auto mt-1 grid w-full grid-cols-4 flex-col items-center justify-start gap-2 rounded-md border border-solid border-[#FFD700] border-opacity-50 px-3 py-1">
      ...
      <span className="flex items-center justify-start gap-2 text-lg !leading-none text-custom md:text-xl xl:text-2xl">
        <Image src={SeiIcon} alt="sei" />#{formatAddress(address)}
      </span>
      <span className=" text-md flex justify-end !leading-none text-[#42543C] md:text-lg  xl:text-xl">
        {self && <p className="w-fit rounded bg-[#D9D9D9] p-2">your rank</p>}
      </span>
      <span className=" text-md flex justify-end font-bold !leading-none text-[#42543C] md:text-lg  xl:text-xl">
